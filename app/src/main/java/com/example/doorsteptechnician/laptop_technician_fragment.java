...
public class laptop_technician_fragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View callView= inflater.inflate(R.layout.fragment_laptop_technician_fragment, container, false);

        laptop_call_btn1 = callView.findViewById(R.id.laptop_call_btn1);
        laptop_call_btn2 = callView.findViewById(R.id.laptop_call_btn2);

        laptop_whatsapp_chat_btn1= callView.findViewById(R.id.laptop_whatsapp_chat_btn1);
        laptop_whatsapp_chat_btn2= callView.findViewById(R.id.laptop_whatsapp_chat_btn2);
        ...
        laptop_call_btn2.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                makePhoneCall2();
            }
        ...
        laptop_start_service_btn2.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                FragmentManager fragmentManager = getActivity().getSupportFragmentManager();
                FragmentTransaction fragmentTransaction = fragmentManager.beginTransaction();
    ...
    private void makePhoneCall2(){
        String phoneNumber = "+923006332639";
        if (ContextCompat.checkSelfPermission(getActivity(), Manifest.permission.CALL_PHONE)
                != PackageManager.PERMISSION_GRANTED) {
            ActivityCompat.requestPermissions(getActivity(), new String[] {Manifest.permission.CALL_PHONE},
                    REQUEST_CALL_PHONE);
