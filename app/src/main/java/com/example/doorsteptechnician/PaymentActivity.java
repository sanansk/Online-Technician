...
public class PaymentActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        System.out.println("Sanan: price_before : " +price);

        String[] values = price.split("\\.");
        price = values[0];
        price = price + "00";
        System.out.println("Sanan: price : " +price);

        Date Date = new Date();
        SimpleDateFormat dateFormat = new SimpleDateFormat("yyyyMMddkkmmss");
        String DateString = dateFormat.format(Date);
        System.out.println("Sanan: DateString : " +DateString);
        ...
        System.out.println("Sanan: expiryDateString : " +expiryDateString);

        String TransactionIdString = "T" + DateString;
        System.out.println("Sanan: TransactionIdString : " +TransactionIdString);

        String pp_MerchantID = "MC56371";
        String pp_Password = "92t459z875";
        String IntegritySalt = "utt9585hvu";
        ...
        pp_SecureHash = php_hash_hmac(sortedString, IntegritySalt);
        System.out.println("Sanan: sortedString : " +sortedString);
        System.out.println("Sanan: pp_SecureHash : " +pp_SecureHash);
        ...
        System.out.println("Sanan: postData : " +postData);
    ...
    private class MyWebViewClient extends WebViewClient {
        ...
        public void onPageStarted(WebView view, String url, Bitmap favicon) {
            if(url.equals(paymentReturnUrl)){
                System.out.println("Sanan: return url cancelling");
                view.stopLoading();
                return;
            }
    ...
    private class FormDataInterface {
        ...
        public void processFormData(String url, String formData) {
            Intent i = new Intent(PaymentActivity.this, payment.class);

            System.out.println("Sanan: Url:" + url + " form data " + formData);
            if (url.equals(paymentReturnUrl)) {
                String[] values = formData.split("&");
                for (String pair : values) {
                    String[] nameValue = pair.split("=");
                    if (nameValue.length == 2) {
                        System.out.println("Sanan: Name:" + nameValue[0] + " value:" + nameValue[1]);
